...
# Create the ndtp namespace
resource "kubernetes_namespace" "ndtp" {
   metadata {
     name = "ndtp"
   }
}

# Create the ServiceAccount in the ndtp namespace
resource "kubernetes_service_account" "secure_agent_graph_sa" {
   metadata {
     name      = "secure-agent-graph-sa"
...
resource "kubernetes_cluster_role_binding" "secure_agent_graph_binding" {
   metadata {
     name = "secure-agent-graph-binding"
   }
